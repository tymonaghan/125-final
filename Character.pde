class Character { //begin Character class
  ...
  void checkWater() {
    ...
    text("oxygen level:"+(lungCapacity-wetness), 50, 100); //ON-SCREEN OXYGEN INDICATOR
  }//end checkWater
  ...
  void hazardCheck(int hazardX_, int hazardY_){
    int hazX = hazardX_;
    int hazY = hazardY_;
    if (xPos > hazX-generousity && xPos < hazX+generousity && yPos > hazY -generousity && yPos < hazY +generousity) {
